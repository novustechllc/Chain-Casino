...
module casino::IntegrationTest {
    ...
    #[
        expected_failure(
            abort_code = casino::InvestorToken::E_INSUFFICIENT_TREASURY,
    ...
    fun test_treasury_depleted_by_game_payouts() {
        ...
        // Big payout 1 - treasury has 5 APT, bet 0.01 APT, expect 2 APT payout
        ...
        // Big payout 2 - treasury has ~3.01 APT, bet 0.01 APT, expect 2 APT payout
        ...
        // Big payout 3 - treasury has ~1.02 APT, bet 0.01 APT, expect 1 APT payout
